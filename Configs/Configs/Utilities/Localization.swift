...
enum L10n {
    ...
    private static let localizedStrings: [String: [AppLanguage: String]] = [
        ...
        "git.project": [.english: "Git Project", .chinese: "Git 项目"],
        ...
        "undo": [.english: "Undo", .chinese: "撤销"],
        "undo.this.change": [.english: "Undo this change and restore the previous version", .chinese: "撤销本次修改并恢复到上一个版本"],
        "undo.version": [.english: "Undo Change", .chinese: "撤销修改"],
        "undo.version.message": [.english: "Are you sure you want to undo this change and restore version %@? This will replace the current content in the editor.", .chinese: "确定要撤销本次修改并恢复到版本 %@ 吗？这会替换编辑器中的当前内容。"],
        "undoing": [.english: "Undoing...", .chinese: "撤销中..."],
        "undoing.version": [.english: "Undoing change...", .chinese: "正在撤销修改..."],
        "restore": [.english: "Restore", .chinese: "恢复"],
        "restore.this.version": [.english: "Restore to this version", .chinese: "恢复到这个版本"],
        "restore.version": [.english: "Restore Version", .chinese: "恢复版本"],
        "restore.version.message": [.english: "Are you sure you want to restore version %@? This will replace the current content in the editor.", .chinese: "确定要恢复到版本 %@ 吗？这会替换编辑器中的当前内容。"],
        ...
        "select.commit.description": [.english: "Choose a commit from the timeline above to view its changes and restore it", .chinese: "从上方时间线选择一个提交，以查看变更并恢复版本"],
        ...
        "version.undone.successfully": [.english: "Change undone successfully", .chinese: "修改已撤销"],
        "version.restored.successfully": [.english: "Version restored successfully", .chinese: "版本已恢复"],
